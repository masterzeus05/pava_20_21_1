...
public class ComplexTest {
    ...
    public void shouldEqualString(Device device, Shape shape, Brush brush, String result) {
        assertEquals(result, UsingMultipleDispatch.invoke(device,"draw", shape, brush));
    }
}
